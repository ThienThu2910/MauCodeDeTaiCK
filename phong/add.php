            ...
            <form method="POST" id="formPhong" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="trang_thai" class="form-select">
                        <option value="trong" <?= (isset($_POST['trang_thai']) && $_POST['trang_thai'] == 'trong') ? 'selected' : '' ?>>Trống</option>
                        <option value="da_dat" <?= (isset($_POST['trang_thai']) && $_POST['trang_thai'] == 'da_dat') ? 'selected' : '' ?>>Đang bận</option>
                    </select>
                </div>
