        ...
        <div class="container my-5">
            ...
            <div class="row g-5 mt-2">
                ...
                <div class="col-md-5 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-4 p-4 rounded border shadow-sm" style="background-color: var(--bs-tertiary-bg);">
                        <h4 class="fw-bold text-uppercase fs-6 mb-3 text-gold"><i class="bi bi-calendar-plus"></i> Đặt Phòng Trực Tuyến</h4>
                        
                        <form action="xu_ly_dat_phong.php" method="POST">
                            <input type="hidden" name="id_phong" value="<?= $room['id'] ?>">
                            <input type="hidden" name="gia_phong" value="<?= $room['gia_phong'] ?>">

                            <div class="mb-3">
                                <label class="form-label small fw-bold">Họ và tên khách hàng</label>
                                <input type="text" name="ho_ten" class="form-control form-control-sm" required placeholder="Ví dụ: Nguyễn Văn A">
                            </div>
                            <div class="mb-3">
                                <label class="form-label small fw-bold">Số điện thoại liên hệ</label>
                                <input type="tel" name="so_dien_thoai" class="form-control form-control-sm" required placeholder="Ví dụ: 0912345678">
                            </div>
                            <div class="row g-2 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Ngày nhận phòng</label>
                                    <input type="date" name="ngay_den" class="form-control form-control-sm" required min="<?= date('Y-m-d') ?>">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Ngày trả phòng</label>
                                    <input type="date" name="ngay_di" class="form-control form-control-sm" required>
                                </div>
                            </div>
                            
                            <button type="submit" class="btn btn-gold btn-lg w-100 py-2 text-uppercase fs-6 <?= $room['trang_thai'] != 'trong' ? 'disabled btn-secondary' : '' ?>">
                                <i class="bi bi-bookmark-check-fill me-2"></i> <?= $room['trang_thai'] == 'trong' ? 'Xác Nhận Đặt Phòng' : 'Phòng Đang Được Thuê' ?>
                            </button>
                        </form>
                    </div>
